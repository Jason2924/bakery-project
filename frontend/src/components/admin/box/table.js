  ...
  return (
    <div className='admin__form'>
      <Form method='post' action={action}>
        ...
        <Field>
          <Button type='submit' variant='primary' className='me-3'><i class="bi bi-upload me-1"></i> Submit</Button>
          <Button type='button' variant='secondary' onClick={() => {window.history.back()}}><i class="bi bi-arrow-90deg-left me-1"></i>Cancel</Button>
        </Field>
      </Form>
    </div>
  );
